...
{
    public decimal? OpenedOdometerKm { get; set; }
...
public class SlaClock { public DateTime? StoppedAt {get;set;} public Guid Id { get; set; } = Guid.NewGuid(); public Guid ServiceEventId { get; set; } public string ClockType { get; set; } = "Resolution"; public DateTime StartedAt { get; set; } = DateTime.UtcNow; public DateTime? DueAt { get; set; } public DateTime? PausedAt { get; set; } public int TotalPausedMinutes { get; set; } public string PauseReason { get; set; } = string.Empty; public string Status { get; set; } = "Running"; }
...
public class VehicleDocument { public string DocumentScope {get;set;} = "Customer"; public Guid? VehicleModelMasterId {get;set;} public string Manufacturer {get;set;} = ""; public string VehicleType {get;set;} = ""; public string ModelName {get;set;} = ""; public string Revision {get;set;} = ""; public string Title {get;set;} = ""; public Guid? JobCardId {get;set;} public DateTime? ExpiresAt {get;set;} public byte[] Content {get;set;} = Array.Empty<byte>(); public string ContentType {get;set;} = "application/octet-stream"; public Guid Id { get; set; } = Guid.NewGuid(); public Guid? VehicleId { get; set; } public string DocumentType { get; set; } = string.Empty; public string FileName { get; set; } = string.Empty; public string StorageReference { get; set; } = string.Empty; public string UploadedBy { get; set; } = string.Empty; public DateTime UploadedAt { get; set; } = DateTime.UtcNow; public string Status { get; set; } = "Active"; }
public class DocumentAttachment { public Guid Id { get; set; } = Guid.NewGuid(); public Guid VehicleDocumentId { get; set; } public string FileName { get; set; } = string.Empty; public string ContentType { get; set; } = "application/octet-stream"; public byte[] Content { get; set; } = Array.Empty<byte>(); public string UploadedBy { get; set; } = string.Empty; public DateTime UploadedAt { get; set; } = DateTime.UtcNow; public bool IsActive { get; set; } = true; }
