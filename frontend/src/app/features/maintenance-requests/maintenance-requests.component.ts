...
@Component({selector:'app-maintenance-requests',standalone:true,imports:[FleetDateComponent,CommonModule,FormsModule],template:`
<section class="page">
...
<div class="card"><table><tr><th>Request</th><th>Requested On</th><th>Target Date</th><th>Vehicle</th><th>Source</th><th>Type</th><th>Complaint</th><th>Priority</th><th>Description</th><th>Status</th><th>Action</th></tr>
...
<tr *ngIf="!rows.length"><td colspan="11" class="empty">No maintenance requests.</td></tr></table></div>
